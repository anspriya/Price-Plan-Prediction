  ...
  async function handleSubmit(event) {
    ...
    if (role === "customer") {
      ...
      try {
        ...
        console.log(
          "CUSTOMER FOUND FROM BACKEND:",
          customer
        );


        // Send actual customer data to App.jsx
        onLogin(customer);
        ...
        <div className="login-panel w-full max-w-md p-8">
          ...
          >
              ...
              <>
                ...
                <div>
                  ...
                  <p className="mt-2 text-[10px] text-slate-400">
                    ...
                    Use the permanent admin password
            ...
            {/* =================================================
                ...
                THIS APPEARS ONLY FOR CUSTOMER
            ================================================= */}
              ...
              <div className="mt-4 text-center">
                ...
                <p className="text-sm text-slate-500">
                  ...
                  <button
                    ...
                    className="ml-1 font-bold text-purple-600 transition-colors hover:text-purple-800 hover:underline"
                  >
