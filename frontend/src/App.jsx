...
import { UserPlus, Phone, Clock, ArrowRight, ShieldCheck } from "lucide-react";
...
function App() {
  ...
  async function handleLogin(loginData) {
    ...
    try {
      ...
      /*
         Allow dashboard even if backend
         temporarily fails.
      */
  ...
  function handleRegistration(customerData) {
    ...
    const registeredCustomer = {
      ...
      usage: {
        ...
        international_minutes:
          Number(customerData.international_minutes) || 0,
      },
      day_minutes: Number(customerData.day_minutes) || 0,
      evening_minutes: Number(customerData.evening_minutes) || 0,
      night_minutes: Number(customerData.night_minutes) || 0,
...
function RegistrationPage({
  ...
  function handleCustomerNumber(event) {
    event.preventDefault();

    const phone = formData.phone_number.trim();

    if (!phone) {
      setError("Please enter your customer number.");
      return;
    }

    setError("");

    // Move to the usage page
    setStep(2);
  }
  ...
  function handleRegistrationSubmit(event) {
    ...
    if (!phone) {
      setError("Customer number is missing.");
      return;
    }
    ...
    for (const field of usageFields) {
      ...
      if (
        ...
        setError(
          "Please enter valid values in all usage fields."
        );
        return;
      }
    }
    ...
    const customerData = {
      phone_number: phone,
      day_minutes: Number(formData.day_minutes),
      evening_minutes: Number(formData.evening_minutes),
      night_minutes: Number(formData.night_minutes),
    ...
    // Send the customer to App.jsx
    // App.jsx will open the normal customer dashboard.
    onRegister(customerData);
  }

  /* ============================================================
     BACK TO CUSTOMER NUMBER
  ============================================================ */

  function handleBackToCustomerNumber() {
    setError("");
    setStep(1);
  }
      ...
      <div className="mx-auto w-full max-w-xl">
        ...
        <div className="mb-7 text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">
            {step === 1
              ? "Enter your customer number to continue."
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    Customer: {formData.phone_number}
                  </p>
                </div>
              ...
              <button
                type="button"
                onClick={handleBackToCustomerNumber}
                className="
                  w-full
                  rounded-xl
                  border
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-1 text-[11px] leading-5 text-slate-500">
                    Your usage values are used to prepare
